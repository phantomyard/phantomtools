...
class TestAddDepartmentWizardChoices(unittest.TestCase):
    @patch("phantomforge.wizard.interactive.add_department")
    @patch("phantomforge.wizard.interactive.click.prompt")
...
class TestAddRoleWizardChoices(unittest.TestCase):
    @patch("phantomforge.wizard.interactive.add_role")
    @patch("phantomforge.wizard.interactive.click.prompt")
...
class TestAddActorWizardChoices(unittest.TestCase):
    @patch("phantomforge.wizard.interactive.add_actor")
    @patch("phantomforge.wizard.interactive.click.prompt")

"""Tests for `pf setup` (wizard/setup.py pure logic + the CLI command)."""
...
from phantomforge.wizard.setup import (
    PersonaPlan,
    SetupPlan,
    _slugify,
    build_org_yaml,
...
class TestSetupCommand(_TmpOrgsTestCase):
    """End-to-end: `pf setup` with simulated interactive input."""

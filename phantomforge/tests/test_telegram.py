...
from phantomforge.compiler.telegram import (
    ERROR,
    MISMATCH,
    NO_TOKEN,
    NOT_DECLARED,
...
class TelegramVerifyTestCase(unittest.TestCase):
    ...
    def test_all_declared_and_matching_ok(self):
        ...
        with unittest.mock.patch(
            "phantomforge.compiler.telegram._getme", side_effect=fake
        ):
    ...
    def test_getme_network_error(self):
        with unittest.mock.patch(
            "phantomforge.compiler.telegram.urllib.request.urlopen",
...
class TelegramCheckCliTestCase(unittest.TestCase):
    ...
    def _invoke(self, *extra):
        from phantomforge.compiler.telegram import _getme
